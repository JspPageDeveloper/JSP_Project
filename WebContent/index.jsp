...
<body >
	...
	<div class="container">
			...
			<div class="slip">
				Receipt number :<input type ="text" name="receipt">
			</div>
	  		<div class="slip_date">
            ...
            <div>
            	Amount(in Words): <input type ="text" name="amount">
            </div><br>
            ...
            <div>
            	...
            	<select name="pay" id="payment_for">
          			...
          			<option value="client">Client Solution Support</option>
            ...
            <div>
            	Per session Payment :<input type ="number" name="amount">
            </div><br>
